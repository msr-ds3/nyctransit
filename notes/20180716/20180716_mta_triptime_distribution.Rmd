---
title: "20180716_mta_triptime_distribution"
...
compute_trip_time <- function (start_station, start_line, transfer_station, transfer_line, end_station, start_time) {
    ...
    # TODO: add arrival_time to first_train # 971896
...
# TODO: add train 1 start time and train 2 end time for debugging and evaluating purposes
i = 1
j = 1
...
new_df <- data.frame(starts = as.POSIXct(start_times, origin = "1970-01-01"), ends = as.POSIXct(end_times, origin = "1970-01-01"), diffs = times)

# figure out about creating multiple lists for multiple transfers
```