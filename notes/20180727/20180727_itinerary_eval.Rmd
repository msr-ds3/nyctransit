...
```{r red-line-data}
red_line_data <- read_csv('../../data/itineraries-Red-Line-96-23-train.csv')
...
```{r orange-line-data}
orange_line_data <- read_csv('../../data/itineraries-Orange-Line-96-23-train.csv')
